...
int main (int argc, char *argv[])
{
  ...
  */
  for (int j=1;j < s_nodes; j++){
	...
	*/
    cmd_oss << "10." << j*2+2 << ".0.1";
  	adrs_set.insert(map<int, string>::value_type(j*2, cmd_oss.str().c_str ()));
  }
  ...
  adrs_set2.insert(map<int, string>::value_type(0, "10.2.0.1"));
  adrs_set3.insert(map<int, string>::value_type(2, "10.4.0.1"));
  ...
  int *constant_set = constant_pros(3600, 6000, 10, &constant_size);
  ...
  */
  ...
  socketTraffic(adrs_set, 0, 3.5, 6.0, nodes);
